 ...
 <div class="col-lg-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('employee.update',$employee->id)}}" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" placeholder="Type here" class="form-control"name="first_name" id="first_name" value="{{$employee->first_name}}">
                                </div>
                                <div class="mb-4">
                                    <label for="product_name" class="form-label">Last Name</label>
                                    <input type="text" placeholder="Type here" class="form-control"name="last_name" id="last_name" value="{{$employee->last_name}}">
                                </div>
                                <div class="mb-4">
                        ...
                        <div class="mb-4">
                                    ...
                                    <input type="text" placeholder="Type here" class="form-control"name="email" id="email" value="{{$employee->email}}">
                                </div>
                                <div class="mb-4">
                                    <label for="product_name" class="form-label">Phone</label>
                                    <input type="text" placeholder="Type here" class="form-control"name="phone" id="phone" value="{{$employee->phone}}">
                                </div>
